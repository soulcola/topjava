...
public class MealTestData {
    ...
    public static final String BETWEEN_START_DATE = "2020-01-30";
    public static final String BETWEEN_END_DATE = "2020-01-31";
    public static final String BETWEEN_START_TIME = "10:00";
    public static final String BETWEEN_END_TIME = "12:00";
    ...
    public static final List<Meal> mealsBetween = List.of(meal5, meal1);
